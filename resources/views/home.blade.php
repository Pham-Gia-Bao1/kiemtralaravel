...
.product-item{
                        ...
                        <div id="tab_20" class="tabcontent" style="display: block;">    
                            <div class="woocommerce columns-4 ">
                                <div class="grid-uniform md-mg-left-10 products columns-4">
                                    <div class="md-pd-left10 grid__item large--one-quarter medium--one-third small--one-half" id="box_prodducts">

                                        @foreach ($foods as $food)
                                        @if ($food->category == 'hoa quả')
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="detail?id={{$food->id}}">
                                                    <img width="260" height="260" src="assets/img/{{$food->main_img}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="NHO XANH" /> </a>
                                            </div>
                                            <div class="product-info">
                                                ...
                                                <div class="product-price clearfix">
                                                    <span class="current-price"><span class="woocommerce-Price-amount amount">{{$food->old_price}}0<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                                                    <span class="original-price"><s><span class="woocommerce-Price-amount amount">{{$food->new_price}}0<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
                                                </div>
                            ...
                            <div class="woocommerce columns-4 ">
                                <div class="grid-uniform md-mg-left-10 products columns-4">
                                    <div class="md-pd-left10 grid__item large--one-quarter medium--one-third small--one-half" id="box_prodducts">
                                        ...
                                        @foreach ($foods as $food)
                                        @if ($food->category == 'thực phẩm khô')
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="detail?id={{$food->id}}">
                                                    <img width="260" height="260" src="assets/img/{{$food->main_img}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="NHO XANH" /> </a>
    ...
    <section id="w366_home_featured_product-2" class="widget w366_home_featured_product">				<section id="home-featured-products">
        <div class="wrapper">
            <div class="inner">
                <div class="section-title">
        ...
        <section id="w366_home_gallery_slider-2" class="widget w366_home_gallery_slider">				<section id="home-gallery">
                	<div class="wrapper">
						<div class="inner">
                        	<div class="gallery-slider grid">
                                @foreach ($foods as $food)
                                    ...
                                    <div class="gallery-item grid__item">
                                        <a href="" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6601866d3de28" data-caption="gallery 1">
                                            <img src="assets/img/{{$food->img}}" alt="">
                                            <div class="overlay">
...
<li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng dẫn mua hàng</a></li>
					...
					<h3 class="footer-title">GALLERY</h3>					<div class="grid gallery-wrapper mg-left-15">
                                ...
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img3.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6601866d42a05" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6601866d42a05" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery6601866d42a05" data-caption="gallery 1">
